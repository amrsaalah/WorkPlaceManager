...
public class TimesAbsentBarChartFragment extends BaseFragment implements IBarChart.view {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v;
        v = inflater.inflate(R.layout.fragment_times_absent_chart , container  , false);

        MyApp.getComponent().newControllerComponent(new ControllerModule(this)).inject(this);

        barChart = v.findViewById(R.id.times_absent_barchart);
        beginningView = v.findViewById(R.id.beginning_view);

        presenter.loadBarChartAbsentData();
        return v;
    }
    ...
    public void addBarChartEntries(List<Float> floatList , EmployeeXAxisFormatter formatter) {
        ...
        BarDataSet set = new BarDataSet(entries, "EmployeeTimesAbsent");
